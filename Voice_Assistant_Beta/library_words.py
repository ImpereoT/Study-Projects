...
'как дела': 'Отстань, мешок с костями',
'какая погода': 'сейчас скажу',
'что там на улице': 'сейчас посмотрю',
'сколько градусов': 'можешь высунуть голову в окно, но сейчас гляну',
'что сейчас на улице': 'сейчас гляну',
'какая погода на улице': 'думаешь, не взять ли зонт?',
