class Configure_widgets:
    ...
    def configure_cpu_bar(self):
        ...
        self.wheel = self.after(1000, self.configure_cpu_bar)   #Метод обновления(self.after)

    def configure_win(self):
        if self.wm_overrideredirect():   #Вызов окна с рамкой
    ...
    def clear_win(self):
        for i in self.winfo_children(): #Возврат виджетов на главном окне
            i.destroy()
